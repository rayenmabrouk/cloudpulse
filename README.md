...
I built this project with an AI assistant (Claude) as a pair programmer. It proposed designs and drafted code, commands and parts of this documentation. I ran every command, reviewed every Terraform plan and pull request, worked through every failure, and made the final decisions. `docs/architecture.md` and `docs/security.md` are written by me.
